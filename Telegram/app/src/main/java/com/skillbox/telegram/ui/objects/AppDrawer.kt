package com.skillbox.telegram.ui.objects
...
import com.skillbox.telegram.ui.fragments.ContactsFragment
import com.skillbox.telegram.ui.fragments.SettingsFragment
import com.skillbox.telegram.utilites.APP_ACTIVITY
import com.skillbox.telegram.utilites.USERModel
import com.skillbox.telegram.utilites.replaceFragment
...
class AppDrawer {
    ...
    private fun createHeader() {
        currentProfile = ProfileDrawerItem()
            ...
            .withEmail(USERModel.phoneNumber)
            .withIcon(USERModel.photoUrl)
            .withIdentifier(200)
        header = AccountHeaderBuilder()
            .withActivity(APP_ACTIVITY)
            .withHeaderBackground(R.drawable.heador)
            .addProfiles(
                currentProfile
            ).build()
    }
